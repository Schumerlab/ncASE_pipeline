...
while(my $line1 =<IN1>){
    ...
    if(($read_type eq 'SE') && (($mapper =~ 'bwa') or ($mapper =~ 'BWA'))){
    ...
    if(($read_type eq 'PE') && (($mapper =~ 'bwa')  or ($mapper =~ 'BWA'))){
    ...
    if(($read_type eq 'SE') && (($mapper =~ 'star') or ($mapper =~ 'STAR'))){
    ...
    if(($read_type eq 'PE') && (($mapper =~ 'star') or ($mapper =~ 'STAR'))){
